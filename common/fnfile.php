...
function Halaman($Jumlah=0, $PerHal=0, $NameHal="Hal", $Lokasi="", $batas=5, $fnGotoHal='gotoHalaman') {
	...
	*/
	...
	$Ops = "<select name='cbxhalaman' id='cbxhalaman' style='height: 24px; border-radius: 2px;padding-left: 9px;padding-right: 9px;' onChange=\"$Kos;$fnGotoHal('$NameHal',this.value)\">$Ops</select>";
	$Str = " <input $disSebelum type=button value='Awal' onClick=\"$Kos;$fnGotoHal('$NameHal',$Awal)\">
			<input $disSebelum type=button value='Sebelum' onClick=\"$Kos;$fnGotoHal('$NameHal',$Sebelum)\">
			$Ops <input $disSesudah type=button value='Sesudah' onClick=\"$Kos;$fnGotoHal('$NameHal',$Sesudah)\">
			<input $disSesudah type=button value='Akhir' onClick=\"$Kos;$fnGotoHal('$NameHal',$Akhir)\">
	 ...
	 )
{
	...
	$Ops = "<select name='cbxhalaman' id='cbxhalaman' style='height: 24px; border-radius: 2px;padding-left: 9px;padding-right: 9px;' onChange=\"$fnGotoHal('page',this.value)\">$Ops</select>";
	$Str = " <input $disSebelum type=button class='btn btn-success btn-sm' value='Awal' onClick=\"$fnGotoHal('awal',$Awal)\">
			<input $disSebelum type=button class='btn btn-success btn-sm' value='Sebelum' onClick=\"$fnGotoHal('sebelum',$Sebelum)\">
			$Ops <input $disSesudah type=button class='btn btn-success btn-sm' value='Sesudah' onClick=\"$fnGotoHal('sesudah',$Sesudah)\">
			<input $disSesudah type=button class='btn btn-success btn-sm' value='Akhir' onClick=\"$fnGotoHal('akhir',$Akhir)\">
			&nbsp;<input  type=button class='btn btn-success btn-sm' value='Lihat Halaman'
