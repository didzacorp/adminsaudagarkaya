...
class GenerateJSON extends Config{
  ...
  function __construct(){
    ...
    // $explodeSettingStatusAset = explode(",",$getKondisiSettingInventaris['nilai']);
    $explodeSettingStatusAset = array('3');
    for ($iSetting=0; $iSetting < sizeof($explodeSettingStatusAset); $iSetting++) {
      $getDataRekapInventaris = $this->sqlQuery("select * from rekap_inventaris where  status_aset = '".$explodeSettingStatusAset[$iSetting]."' and id > 434385 ");
      while ($dataRekapInventaris = $this->sqlArray($getDataRekapInventaris)) {
        $getHargaInventarisBaik = $this->sqlArray($this->sqlQuery("select count(id) as jumlahBarang ,sum(harga_perolehan), sum(harga_penyusutan) from inventaris where c1 = '".$dataRekapInventaris['c1']."' and c = '".$dataRekapInventaris['c']."' and d = '".$dataRekapInventaris['d']."' and e = '".$dataRekapInventaris['e']."' and e1 = '".$dataRekapInventaris['e1']."' and f='".$dataRekapInventaris['f']."' and g='".$dataRekapInventaris['g']."' and h='".$dataRekapInventaris['h']."' and i='".$dataRekapInventaris['i']."' and j='".$dataRekapInventaris['j']."' and kondisi='1' and status_aset_sebelumnya = '".$explodeSettingStatusAset[$iSetting]."' "));
        $getHargaInventarisKurangBaik = $this->sqlArray($this->sqlQuery("select count(id) as jumlahBarang ,sum(harga_perolehan), sum(harga_penyusutan) from inventaris where c1 = '".$dataRekapInventaris['c1']."' and c = '".$dataRekapInventaris['c']."' and d = '".$dataRekapInventaris['d']."' and e = '".$dataRekapInventaris['e']."' and e1 = '".$dataRekapInventaris['e1']."' and f='".$dataRekapInventaris['f']."' and g='".$dataRekapInventaris['g']."' and h='".$dataRekapInventaris['h']."' and i='".$dataRekapInventaris['i']."' and j='".$dataRekapInventaris['j']."' and kondisi='2' and status_aset_sebelumnya = '".$explodeSettingStatusAset[$iSetting]."' "));
        $getHargaInventarisRusakBerat = $this->sqlArray($this->sqlQuery("select count(id) as jumlahBarang ,sum(harga_perolehan), sum(harga_penyusutan) from inventaris where c1 = '".$dataRekapInventaris['c1']."' and c = '".$dataRekapInventaris['c']."' and d = '".$dataRekapInventaris['d']."' and e = '".$dataRekapInventaris['e']."' and e1 = '".$dataRekapInventaris['e1']."' and f='".$dataRekapInventaris['f']."' and g='".$dataRekapInventaris['g']."' and h='".$dataRekapInventaris['h']."' and i='".$dataRekapInventaris['i']."' and j='".$dataRekapInventaris['j']."' and kondisi='3' and status_aset_sebelumnya = '".$explodeSettingStatusAset[$iSetting]."' "));
        $getHargaInventarisTidakAda = $this->sqlArray($this->sqlQuery("select count(id) as jumlahBarang ,sum(harga_perolehan), sum(harga_penyusutan) from inventaris where c1 = '".$dataRekapInventaris['c1']."' and c = '".$dataRekapInventaris['c']."' and d = '".$dataRekapInventaris['d']."' and e = '".$dataRekapInventaris['e']."' and e1 = '".$dataRekapInventaris['e1']."' and f='".$dataRekapInventaris['f']."' and g='".$dataRekapInventaris['g']."' and h='".$dataRekapInventaris['h']."' and i='".$dataRekapInventaris['i']."' and j='".$dataRekapInventaris['j']."' and ada='2' and status_aset_sebelumnya = '".$explodeSettingStatusAset[$iSetting]."' "));

        $dataUpdate = array(
          'jumlah_baik' => $getHargaInventarisBaik['jumlahBarang'],
          'harga_baik' => $getHargaInventarisBaik['sum(harga_perolehan)'],
          'jumlah_kurang_baik' => $getHargaInventarisKurangBaik['jumlahBarang'],
          'harga_kurang_baik' => $getHargaInventarisKurangBaik['sum(harga_perolehan)'],
          'jumlah_rusak_berat' => $getHargaInventarisRusakBerat['jumlahBarang'],
          'harga_rusak_berat' => $getHargaInventarisRusakBerat['sum(harga_perolehan)'],
          'penyusutan_rusak_berat' => $getHargaInventarisRusakBerat['sum(harga_penyusutan)'],
          'jumlah_tidak_ada' => $getHargaInventarisTidakAda['jumlahBarang'],
          'harga_tidak_ada' => $getHargaInventarisTidakAda['sum(harga_perolehan)'],
          'penyusutan_tidak_ada' => $getHargaInventarisTidakAda['sum(harga_penyusutan)'],
        );
        $queryUpdateRekap = $this->sqlUpdate("rekap_inventaris",$dataUpdate,"id = '".$dataRekapInventaris['id']."'");
        $this->sqlQuery($queryUpdateRekap);
        $kodeSKPD = $dataRekapInventaris['c1'].".".$dataRekapInventaris['c'].".".$dataRekapInventaris['d'].".".$dataRekapInventaris['e'].".".$dataRekapInventaris['e1'];
        $kodeBarang = $dataRekapInventaris['f'].".".$dataRekapInventaris['g'].".".$dataRekapInventaris['h'].".".$dataRekapInventaris['i'].".".$dataRekapInventaris['j'];
        echo $explodeSettingStatusAset[$iSetting]." => ".$kodeSKPD." => ".$kodeBarang." ".$dataRekapInventaris['id']." ;\n";
        // echo "$queryUpdateRekap;\n";
