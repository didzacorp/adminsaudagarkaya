...
//    $explodeSettingStatusAset = explode(",",$getKondisiSettingInventaris['nilai']);
    $explodeSettingStatusAset = array('10');
    for ($iSetting=0; $iSetting < sizeof($explodeSettingStatusAset); $iSetting++) {
      $getDataRekapInventaris = $this->sqlQuery("select * from rekap_inventaris where  status_aset = '".$explodeSettingStatusAset[$iSetting]."' ");
