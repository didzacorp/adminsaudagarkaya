...
gj.widget = function() {
    ...
    function(a) {
        ...
        initialize: function(a) {
            ...
            0 === c.length ? (c = $('<div role="wrapper" style="width:125px;"  />').addClass(b.style.wrapper), a.wrap(c)) : c.addClass(b.style.wrapper), b.fontSize && f.css("font-size", b.fontSize), f.on("click", function(b) {
